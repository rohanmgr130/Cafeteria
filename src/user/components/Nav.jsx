...
function Nav() {
  ...
  // Handle scroll detection - make navbar transparent when at top
  const handleScroll = () => {
    ...
    <>
      <nav
        className={`fixed top-0 left-0 z-50 w-full transition-all duration-500 ${
          isScrolled ? "bg-gray-800 shadow-lg h-14" : "bg-transparent h-16"
        }`}
      >
        ...
        {isMenuOpen && (
          <div
            ref={mobileMenuRef}
            className="md:hidden fixed inset-0 top-14 bg-gray-800 bg-opacity-95 z-40 flex flex-col py-4 px-2"
          >
