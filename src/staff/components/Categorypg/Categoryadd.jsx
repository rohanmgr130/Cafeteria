...
function Categoryadd() {
  ...
  // Use your API base URL - make sure this is correctly set in your .env file
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let res;
      if (editMode) {
        // Updated endpoint for updating a category
        res = await axios.put(`${API_BASE_URL}/api/category/${currentCategoryId}`, data);
      } else {
        // Updated endpoint for creating a category
        res = await axios.post(`${API_BASE_URL}/api/category`, data);
      }
  ...
  const fetchCategories = useCallback(async (retry = true) => {
    ...
    try {
      console.log("Fetching categories from:", `${API_BASE_URL}/api/category/get-all-category`);
  ...
  const editCategory = (category) => {
    ...
    // Set image preview - make sure to use the correct path
  ...
  // CategoryCard component with improved text visibility and error handling
        ...
        <div className="relative aspect-w-16 aspect-h-9 h-64">
          <img
            ...
            onError={(e) => {
              ...
              e.target.src = 'data:image/svg+xml;base64,';
            }}
          />
